...
## Project Overview
This project uses Claude Code to assist with product management workflows for CalmFalcon, an AI-powered AI Signals Intelligence platform.

CalmFalcon helps enterprise AI teams review signals faster using AI-powered theme extraction, confidence scoring and provide weekly briefs with transparency of "why" behind it.
...
**System Prompts (Use for specific Prompts):**
- `@sampleprompts/market-research-format.md` - System Prompt for market research deliverables
- `@sampleprompts/user-research-format.md` - System Prompt for user research deliverables
- `@sampleprompts/prd-template.md` - System Prompt for Product Requirements Documents
